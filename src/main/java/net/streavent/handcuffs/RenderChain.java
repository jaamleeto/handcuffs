...
public class RenderChain {
	private static ResourceLocation TEXTURE = new ResourceLocation("handcuffs:textures/item/chain_holder.png");
	...
	public static void render(LivingEntity entityLivingIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int lightIn) {
		if (entityLivingIn.getAttribute(HandcuffsAttributes.HANDCUFF_HOLDER.get()) != null && entityLivingIn.getAttribute(HandcuffsAttributes.HANDCUFF_HOLDER.get()).getBaseValue() > 0) {
			Entity chainTarget = entityLivingIn.world.getEntityByID((int) entityLivingIn.getAttribute(HandcuffsAttributes.HANDCUFF_HOLDER.get()).getBaseValue());
			if (chainTarget != null) {
	...
	private static void func_229108_a_(IVertexBuilder p_229108_0_, Matrix4f p_229108_1_, Matrix3f p_229108_2_, float p_229108_3_, float p_229108_4_, float p_229108_5_, int p_229108_6_, int p_229108_7_, int p_229108_8_, float p_229108_9_,
			float p_229108_10_, int packedLight) {
		p_229108_0_.pos(p_229108_1_, p_229108_3_, p_229108_4_, p_229108_5_).color(p_229108_6_, p_229108_7_, p_229108_8_, 255).tex(p_229108_9_, p_229108_10_).overlay(OverlayTexture.NO_OVERLAY).lightmap(packedLight)
				.normal(p_229108_2_, 0.0F, 1.0F, 0.0F).endVertex();
	}

...
public class HandcuffsMod {
	public static final Logger LOGGER = LogManager.getLogger(HandcuffsMod.class);
	public static final String MODID = "handcuffs";
	...
	public HandcuffsMod() {
		...
		HandcuffsCommonConfig.register();
		HandcuffsAttributes.registerAttributes();
	...
	private static class HandcuffsModFMLBusEvents {
		private final HandcuffsMod parent;

		HandcuffsModFMLBusEvents(HandcuffsMod parent) {
			this.parent = parent;
		}
